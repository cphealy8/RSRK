function [pts] = PoissonByIntensity(SigIm,multiplier,TgtNum)
...
% Screen out additional points (or add more). 
if diffnum>0
...
% Add a small amount of noise to impose orderliness. (Ensure points do not
% occupy the same space). 
pts = pts-rand(length(pts),2);
